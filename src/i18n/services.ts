...
export const services = {
  fr: {
    title: 'Josselin HANEL - Offres', description: 'Des sites simples et sur-mesure, pensés pour répondre à votre besoin réel, sans superflu ni surcoût.',
    pageTitle: 'Services & Tarifs', intro: 'Des sites pensés pour votre besoin, ni plus ni moins : intuitifs, rapides à charger, et qui n\'explosent pas votre budget hébergement.',
  ...
  en: {
    title: 'Josselin HANEL - Offers', description: 'Simple, custom-made websites, designed to meet your real needs - without the bloat or the inflated price tag.',
    pageTitle: 'Services & Pricing', intro: "Websites designed around your needs, no more and no less: intuitive, fast-loading, and easy on your hosting budget.",
  ...
  de: {
    title: 'Josselin HANEL - Angebote', description: 'Einfache, maßgeschneiderte Websites, die genau auf Ihren Bedarf zugeschnitten sind - ohne unnötigen Schnickschnack oder Mehrkosten.',
    pageTitle: 'Leistungen & Preise', intro: 'Websites, die zu Ihrem Bedarf passen, nicht mehr und nicht weniger: intuitiv, schnell ladend und schonend für Ihr Hosting-Budget.',

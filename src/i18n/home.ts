...
export const home = {
  fr: {
    ...
    kiss: {
      ...
      p2: "Le résultat : référencement naturel optimal, performances inégalées grâce à la couche de modernité que j'ajoute par-dessus ces standards, et une résilience dans le temps qu'un CMS bardé de plugins (WordPress & co) ne peut pas offrir. Mes projets en sont la preuve : tous atteignent un score <a href=\"https://pagespeed.web.dev/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-link\" title=\"Outil de mesure de performance Google\">Lighthouse</a> de 90 à 100/100.",
    },
  ...
  en: {
    ...
    kiss: {
      ...
      p2: "The result: optimal natural SEO, unmatched performance thanks to the modern layer I add on top of these standards, and long-term resilience that no plugin-heavy CMS (WordPress & co) can match. My projects prove it: they all achieve a <a href=\"https://pagespeed.web.dev/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-link\" title=\"Google performance measurement tool\">Lighthouse</a> score between 90 and 100/100.",
    },
  ...
  de: {
    ...
    kiss: {
      ...
      p2: "Das Ergebnis: optimales natürliches SEO, unübertroffene Performance dank der modernen Schicht, die ich über diese Standards lege, und eine langfristige Resilienz, die kein plugin-überladenes CMS (WordPress & Co) bieten kann. Meine Projekte beweisen es: Sie alle erreichen einen <a href=\"https://pagespeed.web.dev/\" target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-link\" title=\"Googles Performance-Messtool\">Lighthouse</a> Score von 90 bis 100/100.",
    },
